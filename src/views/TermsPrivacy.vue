<template>
  <div class="article">
    ...
    <p>The personal data we routinely (attempt to) collect from you includes:</p>
    ...
    <p>In addition, we collect personal data that you knowingly and willingly
      provide, including</p>
    <ul>
      <li>(when contacting us, whether by email or webform): your name and email
        address</li>
    </ul>
  ...
  <p>The legal basis for collecting this personal data is to perform a task in
    ...
    We may transfer information about users if we are acquired by or merged
    with another company.</p>

  <h1>Cookies</h1>
  <h2>What are cookies?</h2>
  <p>Cookies are text files containing small amounts of information that are
    automatically downloaded to your device when you visit a website. Cookies
    are useful because they allow a website to recognise your device and
    preferences, and can be used to improve your experience online.</p>
  ...
  <p>We will retain your personal data only for as long as:</p>

  <ul>
    <li>it is needed for the purposes set out in this notice</li>
    <li>the law requires</li>
  </ul>

  <h2>Where your personal data is processed and stored</h2>
  <p>We operate our systems to ensure that your personal data is as safe as
    possible at any stage. When your personal data is transferred outside of the
    EEA (European Economic Area) appropriate technical and legal safeguards are
    put in place to ensure that you have the same level of protection as within
    the EEA.</p>

  <h2>How we protect your personal data</h2>
  <p>We are committed to doing all that we can to keep your personal data
    secure. We have systems in place to prevent misuse of your personal data –
    for example, we protect your personal data using varying levels of
    encryption. We also make sure that third parties that we deal with keep
    all personal data they process on our behalf secure.</p>

  <h2>Changes to this notice</h2>
  <p>We may change this Privacy Notice. In that case, any changes will apply to
    you and your personal data immediately. If these changes affect how your
  ...
  <ul>
      ...
      <li>information on how we use your personal data</li>
